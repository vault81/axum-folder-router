...
/// [folder_router] Found route.rs for file: "files/[...path]/route.rs", path: "/files/{*path}", mod_path: ["files", "___path", "route"]
/// [folder_router] Found methods for file: "files/[...path]/route.rs", path: "/files/{*path}", mod_path: ["files", "___path", "route"], methods: ["get"]
/// [folder_router] Found route.rs for file: "files/route.rs", path: "/files", mod_path: ["files", "route"]
/// [folder_router] Found methods for file: "files/route.rs", path: "/files", mod_path: ["files", "route"], methods: ["get", "post"]
/// [folder_router] Found route.rs for file: "ping/route.rs", path: "/ping", mod_path: ["ping", "route"]
/// [folder_router] Found methods for file: "ping/route.rs", path: "/ping", mod_path: ["ping", "route"], methods: ["any", "get"]
/// [folder_router] Found route.rs for file: "route.rs", path: "/", mod_path: ["route"]
/// [folder_router] Found methods for file: "route.rs", path: "/", mod_path: ["route"], methods: ["get", "post"]
/// [folder_router] Found route.rs for file: "users/[id]/route.rs", path: "/users/{:id}", mod_path: ["users", "__id", "route"]
/// [folder_router] Found methods for file: "users/[id]/route.rs", path: "/users/{:id}", mod_path: ["users", "__id", "route"], methods: ["get"]
